...
const styles = {
  ...
  row: { display: 'flex', gap: 24, marginBottom: 36 },
  box: { flex: 1, background: '#fff', padding: 24, borderRadius: 12, boxShadow: '0 1px 4px rgba(0,0,0,0.06)', display: 'flex', flexDirection: 'column', gap: 14 },
